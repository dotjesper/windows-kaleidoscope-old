...
# Proactive remediation: Collect last boot time

Collect last boot time, fails if last boot time is 7 days or above.
...
Description: **Collect last boot time, fails if last boot time is 7 days or above.**
