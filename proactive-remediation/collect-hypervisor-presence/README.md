...
# Proactive remediation: Collect if hypervisor is present

Collect if hypervisor is present, success if either processor supports and enabled or if Hyper-V is present.
...
Name: **Collect if hypervisor is present**

Description: **Collect if hypervisor is present, success if either processor supports and enabled or if Hyper-V is present.**
